...
Ka¿dy z podobszarów obszaru $\Omega$ jest ograniczonych pogrubion¹ krawêdzi¹ i sk³ada siê zawsze z dok³adnie czterech mniejszych podpodobszarów wyznaczanych przez dziewiêæ wêz³ów ($x_{2i},y_{2j}$) ( $i=0,1,\ldots, n$\,\,,\, \mbox{$j=0,1,\ldots, m$} ). Objêtoœæ dowolnego z tych podobszarów wyra¿a wzór:
...
Zaprezentowane dotychczas sposoby wyprowadzania \textit{uogólnionego wzoru Simpsona} nie s¹ jedynymi nam znanymi. Poka¿my, ¿e (zgodnie ze stwierdzeniem z pocz¹tku rozdzia³y) ten sam wzór mo¿emy otrzymaæ poprzez ca³kowanie wielomianu \textit{Lagrange'a} $L_{2,2}(x,y)$. Ca³ka taka jest postaci:
...
\textbf{Analiza wyników i ich porównanie z otrzymanymi przez trapez2.}
