...
\subsection{Ca³kowanie po obszarze normalnym}
...
\end{array}
\end{equation}
Ostatnie przejœcie mog³o zostaæ wykonane, poniewa¿ wynik dla ka¿dej ca³ki $\int\limits_{x_i}^{x_{i+1}} \int\limits_{y_i}^{y_{i+1}} L_{1,1}(x,y) dydx$ jest takiej samej postaci, zmienia siê jedynie numer wêz³a branego pod uwagê. Dla przyk³adu:
\begin{equation}
\begin{array}{cc}
...
Mo¿na spostrzec, ¿e przeprowadzenie pe³nych obliczeñ mo¿e staæ siê bardzo k³opotliwe w przypadku, gdy funkcja podca³kowa ma skomplikowan¹ postaæ, lub liczba wêz³ów liczona jest w dziesi¹tkach b¹dŸ setkach. W takim przypadku bardzo pomocna oka¿e siê specjalna procedura napisana w jêzyku \textit{Maple}, automatyzuj¹ca ca³y proces prowadzenia rachunków. 
...
\subsection{Ca³kowanie po obszarze normalnym ze wzglêdu na jedn¹ zmienn¹}
