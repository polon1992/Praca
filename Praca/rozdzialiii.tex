\chapter{Kwadratury Newtona-Cotesa dla ca³ek podwójnych w obszarach prostok¹tnych}
...
\end{equation}       
Przyjmuj¹c nastêpuj¹ce wartoœci $x_0=0$, $x_1=h$, $x_2=2h$, $y_0=0$, $y_1=k$ oraz $y_2=2k$ mo¿emy (\ref{WzorSimpsona2DZCalkiL22}) rozbiæ na dziewiêæ ca³ek. Wyznaczenie ich spowoduje otrzymanie wspó³czynników wystêpuj¹cych przy wartoœciach funkcji $f(x_i,y_j)$ w kolejnych wêz³ach zgodnych z (\ref{MacierzWspolczynnikowSimpson2_objetosc1podobszaru}), tzn.:
