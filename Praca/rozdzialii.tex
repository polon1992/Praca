...
\centering
 ...
 800& 4,06312239755  &0,000008339 & 0,000045863 \\
  \hline 
 1200& 4,06311776480 & 0,000003706  &0,000020383 \\
  \hline 
...
\begin{ex}(Wyznaczanie przybli¿onej wartoœci ca³ki metod¹ \textit{Simpsona})\\\hfill
...
\end{gather*}
\end{ex}
Wynik, który otrzymaliœmy w przeprowadzonych powy¿ej obliczeniach jest bardzo zbli¿ony do wartoœci dok³adnej $\int\limits_0^{\frac{3}{2}} e^{x^2} dx=4,06311405862...$. Chcemy jednak sprawdziæ, przy jak du¿ej liczbie podzia³ów przedzia³u ca³kowania przybli¿enie zacznie siê stabilizowaæ tak, byœmy mogli uznaæ je za wystarczaj¹co dok³adne (przyjmijmy, ¿e b³¹d bezwzglêdny przybli¿enia ma byæ nie wiêkszy ni¿ $0,0000001$). Podobnie jak dla metody trapezów, wykorzystajmy stworzone na nasze potrzeby procedury. \\ 
...
Powy¿szy skrypt tworzy procedurê \textit{Maple}, realizuj¹c¹ algorytm wyznaczania przybli¿onej wartoœæ ca³ki metod¹ \textit{Simpsona}. Jej parametrami wejœciowymi s¹:\\
