...
\begin{proc}{(Wznaczanie wartoœci ca³ek pojedynczych metod¹ \textit{Simpsona})}\label{MAPLE_MetodaSimpsonaCalkaPojedyncza}
\begin{verbatim}
>simpson :=proc(a,b,N) 
local h,i,j,m,x,y,s,sp;
if (mod(N,2)=1) then 
ERROR('Ostatni parametr musi byc liczba naturalna postaci \2m')
else
	m:=N/2; 
	h:=(b-a)/(2*m); 
