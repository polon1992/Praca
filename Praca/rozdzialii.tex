...
Podstawiaj¹c obliczone powy¿ej wspó³czynniki do (\ref{WzorKwadratura}) otrzymujemy szukany przez nas wzór \textit{Simpsona}: 
...
W przypadku, gdy przedzia³ ca³kowania zostanie podzielony na wiêcej ni¿ $2k$ \mbox{($k=1,2,\ldots$)} podprzedzia³ów równej d³ugoœci $h$, wtedy (\ref{wzorSimpsonaBrakPodzialu}) przyjmie nastêpuj¹c¹ formê:
