...
\sum\limits_{i=0}^n \alpha_i f(x_i) dx= S(f),
\end{equation}
gdzie 
...
a_i=h\int\limits_0^n \left(\prod\limits_{j=0, j\neq i}^n \frac{s-j}{i-j}\right)ds.
\end{equation}  
