...
\end{equation}
przy czym wspó³czynniki $a_i$ s¹ niezale¿ne od $f(x)$ (nazywamy je wspó³czynnikami wagowymi kwadratury i okreœlaj¹ one wielkoœæ udzia³u $d(x_i)$ w wartoœci ca³ej sumy $S(f)$), zaœ $x_i$ nosi miano wêz³ów kwadratury.
...
Zastosujmy w (\ref{l_iDlaKwadraturN-C}) nastêpuj¹ce podstawienie: $x=a+hs$. Wartoœci $a,h$ s¹ pewnymi sta³ymi, natomiast $s$ jest zmienn¹ niezale¿n¹ \cite{klucz7}.
