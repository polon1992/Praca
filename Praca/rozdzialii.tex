...
\begin{proc}{(Wznaczanie wartoœci ca³ek pojedynczych metod¹ trapezów)}\label{MAPLE_MetodaTrapezowCalkaPojedyncza}
\begin{verbatim}
> trapez:=proc(a,b,n) 
...
Równanie (\ref{wzorSimpsonaBrakPodzialu}) opisuje przypadek, dla którego ca³ka $\int\limits_a^b f(x)dx$ jest przybli¿ana polem znajduj¹cym siê tylko pod jedn¹ parabol¹ na przedziale $[a,b]$ (podzielono go na dwa równe podprzedzia³y $[a=x_0,x_1]$ i $[x_1,x_2=b]$). Wykres omawianej paraboli przechodzi przez punkty $(a=x_0,f(x_0))$, $(\frac{b+a}{2}=x_1,f(x_1))$, $(b=x_2,f(x_2))$. 
...
|BBS_{N}|\leq\delta_S
\end{equation}
Przez $\delta_S$ rozumiemy b³¹d metody Simpsona, który jest opisany nastêpuj¹cym wzorem:
\begin{equation}\label{BladMetodyTrapezow}
